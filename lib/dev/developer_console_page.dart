...
class _WhatsevrIconsShowcase extends StatelessWidget {
  ...
  List<(String, IconData)> get _iconData => [
        ('playButton', WhatsevrIcons.playButton),
        ('postMemories', WhatsevrIcons.postMemories),
        ('postUploadIcon002', WhatsevrIcons.postUploadIcon002),
        ('searchIcon', WhatsevrIcons.searchIcon),
        ('share', WhatsevrIcons.share),
        ('uploadPhoto', WhatsevrIcons.uploadPhoto),
        ('wtvIcon', WhatsevrIcons.wtvIcon),
        ('bookMarkIconLine', WhatsevrIcons.bookMarkIconLine),
        ('bookMarkIcon', WhatsevrIcons.bookMarkIcon),
        ('commentIcon', WhatsevrIcons.commentIcon),
        ('editPencil02', WhatsevrIcons.editPencil02),
        ('flicksIcon001', WhatsevrIcons.flicksIcon001),
        ('hamburgerIcon', WhatsevrIcons.hamburgerIcon),
        ('iButtonIcon', WhatsevrIcons.iButtonIcon),
        ('iconExplore002Svg', WhatsevrIcons.iconExplore002Svg),
        ('iconWhatServ001Svg', WhatsevrIcons.iconWhatServ001Svg),
        ('likeOutline', WhatsevrIcons.likeOutline),
        ('likeSolid', WhatsevrIcons.likeSolid),
        ('message', WhatsevrIcons.message),
        ('notificationIcon001', WhatsevrIcons.notificationIcon001),
        ('offerIcon', WhatsevrIcons.offerIcon),
        ('pdfIcon', WhatsevrIcons.pdfIcon),
        ('doctsIcon', WhatsevrIcons.doctsIcon),
