...
class CommunityPageOffersView extends StatelessWidget {
  const CommunityPageOffersView({super.key});
    ...
    return BlocBuilder<CommunityBloc, CommunityState>(
      builder: (BuildContext context, CommunityState state) {
        return ListView.separated(
          ...
          itemCount: state.communityOffers.length,
          itemBuilder: (BuildContext context, int index) {
            final OfferPost? userOfferPost = state.communityOffers[index];
            return Container(
