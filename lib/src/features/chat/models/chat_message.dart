...
//   factory OldChatMessage.fromJson(String str) =>
//       OldChatMessage.fromMap(json.decode(str));

//   String toJson() => json.encode(toMap());

//   factory OldChatMessage.fromMap(Map<String, dynamic> json) => OldChatMessage(
//         uid: json['uid'],
