...
//   factory OldPrivateChat.fromJson(String str) =>
//       OldPrivateChat.fromMap(json.decode(str));

//   String toJson() => json.encode(toMap());

//   factory OldPrivateChat.fromMap(Map<String, dynamic> json) => OldPrivateChat(
//         uid: json['uid'],
