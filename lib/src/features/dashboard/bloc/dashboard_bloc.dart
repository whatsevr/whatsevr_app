  ...
  void _preloadApiIntoCache() async {
    try {
      ...
      await Future.wait([
        ...
        PublicRecommendationApi.publicVideoPosts(page: 1),
        PublicRecommendationApi.publicVideoPosts(page: 2),
        PublicRecommendationApi.publicVideoPosts(page: 3),
        PublicRecommendationApi.publicFlickPosts(page: 1),
        PublicRecommendationApi.publicFlickPosts(page: 2),
        PublicRecommendationApi.publicFlickPosts(page: 3),
        PublicRecommendationApi.publicOffers(page: 1),
        PublicRecommendationApi.publicOffers(page: 2),
        PublicRecommendationApi.publicOffers(page: 3),
        PublicRecommendationApi.publicPhotoPosts(page: 1),
        PublicRecommendationApi.publicPhotoPosts(page: 2),
        PublicRecommendationApi.publicPhotoPosts(page: 3),
        PublicRecommendationApi.publicMemories(page: 1),
        PublicRecommendationApi.publicMemories(page: 2),
        PublicRecommendationApi.publicMemories(page: 3),
