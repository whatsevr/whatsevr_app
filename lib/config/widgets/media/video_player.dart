...
class WhatsevrVideoViewerWithInfo extends StatefulWidget {
  const WhatsevrVideoViewerWithInfo({super.key, required this.video});

  final File video;

  @override
  State<WhatsevrVideoViewerWithInfo> createState() =>
      _WhatsevrVideoViewerWithInfoState();
}

class _WhatsevrVideoViewerWithInfoState
    extends State<WhatsevrVideoViewerWithInfo> {
