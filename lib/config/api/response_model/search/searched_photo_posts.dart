...
class SearchedPhotoPostsResponse {
  final String? message;
  final int? page;
  final bool? lastPage;
  final List<PhotoPost>? photoPosts;

  SearchedPhotoPostsResponse({
    this.message,
    this.page,
    this.lastPage,
    this.photoPosts,
  ...
  SearchedPhotoPostsResponse copyWith({
    String? message,
    int? page,
    bool? lastPage,
  ...
  factory SearchedPhotoPostsResponse.fromJson(String str) =>
      SearchedPhotoPostsResponse.fromMap(json.decode(str));

  String toJson() => json.encode(toMap());

  factory SearchedPhotoPostsResponse.fromMap(Map<String, dynamic> json) =>
      SearchedPhotoPostsResponse(
