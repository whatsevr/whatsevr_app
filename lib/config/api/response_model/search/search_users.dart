...
class SearchedUsersResponse {
  ...
  SearchedUsersResponse copyWith({
    String? message,
    int? page,
    bool? lastPage,
    List<User>? users,
  ...
  factory SearchedUsersResponse.fromJson(String str) =>
      SearchedUsersResponse.fromMap(json.decode(str));

  String toJson() => json.encode(toMap());

  factory SearchedUsersResponse.fromMap(Map<String, dynamic> json) =>
      SearchedUsersResponse(
