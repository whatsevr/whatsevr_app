...
class SearchedFlickPostsResponse {
  final String? message;
  final int? page;
  final bool? lastPage;
  final List<Flick>? flicks;

  SearchedFlickPostsResponse({
    this.message,
    this.page,
    this.lastPage,
    this.flicks,
  ...
  SearchedFlickPostsResponse copyWith({
    String? message,
    int? page,
    bool? lastPage,
    List<Flick>? flicks,
  ...
  factory SearchedFlickPostsResponse.fromJson(String str) =>
      SearchedFlickPostsResponse.fromMap(json.decode(str));

  String toJson() => json.encode(toMap());

  factory SearchedFlickPostsResponse.fromMap(Map<String, dynamic> json) =>
      SearchedFlickPostsResponse(
