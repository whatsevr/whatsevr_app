...
class UserTaggedContentResponse {
  ...
  factory UserTaggedContentResponse.fromJson(String str) =>
      UserTaggedContentResponse.fromMap(json.decode(str));

  String toJson() => json.encode(toMap());

  factory UserTaggedContentResponse.fromMap(Map<String, dynamic> json) =>
      UserTaggedContentResponse(
