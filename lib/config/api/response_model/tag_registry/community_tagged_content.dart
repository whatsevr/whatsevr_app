...
class CommunityTaggedContentResponse {
    ...
    factory CommunityTaggedContentResponse.fromJson(String str) => CommunityTaggedContentResponse.fromMap(json.decode(str));

    String toJson() => json.encode(toMap());

    factory CommunityTaggedContentResponse.fromMap(Map<String, dynamic> json) => CommunityTaggedContentResponse(
