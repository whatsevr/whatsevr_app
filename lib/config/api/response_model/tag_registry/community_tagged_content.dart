...
class CommunityTaggedContentResponse {
  String? message;
  int? page;
  bool? lastPage;
  List<TaggedContent>? taggedContent;

  CommunityTaggedContentResponse({
    this.message,
    this.page,
    this.lastPage,
    this.taggedContent,
  ...
  CommunityTaggedContentResponse copyWith({
    String? message,
    int? page,
    bool? lastPage,
    List<TaggedContent>? taggedContent,
  ...
  factory CommunityTaggedContentResponse.fromJson(String str) =>
      CommunityTaggedContentResponse.fromMap(json.decode(str));

  String toJson() => json.encode(toMap());

  factory CommunityTaggedContentResponse.fromMap(Map<String, dynamic> json) =>
      CommunityTaggedContentResponse(
        message: json['message'],
        page: json['page'],
        lastPage: json['last_page'],
        taggedContent: json['tagged_content'] == null
            ? []
            : List<TaggedContent>.from(
                json['tagged_content']!.map((x) => TaggedContent.fromMap(x)),),
      );
  ...
  Map<String, dynamic> toMap() => {
        ...
        'page': page,
        'last_page': lastPage,
        'tagged_content': taggedContent == null
            ? []
            : List<dynamic>.from(taggedContent!.map((x) => x.toMap())),
      };
}
...
class TaggedContent {
  ...
  factory TaggedContent.fromJson(String str) =>
      TaggedContent.fromMap(json.decode(str));

  String toJson() => json.encode(toMap());

  factory TaggedContent.fromMap(Map<String, dynamic> json) => TaggedContent(
        tagInfo:
            json['tag_info'] == null ? null : TagInfo.fromMap(json['tag_info']),
...
class TagInfo {
  ...
  factory TagInfo.fromMap(Map<String, dynamic> json) => TagInfo(
        ...
        taggedAt: json['tagged_at'] == null
            ? null
            : DateTime.parse(json['tagged_at']),
        taggedBy: json['tagged_by'] == null
            ? null
            : TaggedBy.fromMap(json['tagged_by']),
      );
