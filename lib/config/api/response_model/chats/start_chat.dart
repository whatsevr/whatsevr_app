...
class StartChatResponse {
    ...
    factory StartChatResponse.fromJson(String str) => StartChatResponse.fromMap(json.decode(str));

    String toJson() => json.encode(toMap());

    factory StartChatResponse.fromMap(Map<String, dynamic> json) => StartChatResponse(
