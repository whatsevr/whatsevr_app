...
class UserPrivateChatsResponse {
  ...
  factory UserPrivateChatsResponse.fromJson(String str) =>
      UserPrivateChatsResponse.fromMap(json.decode(str));

  String toJson() => json.encode(toMap());

  factory UserPrivateChatsResponse.fromMap(Map<String, dynamic> json) =>
      UserPrivateChatsResponse(
        ...
        chats: json['chats'] == null
            ? []
            : List<Chat>.from(json['chats']!.map((x) => Chat.fromMap(x))),
      );
