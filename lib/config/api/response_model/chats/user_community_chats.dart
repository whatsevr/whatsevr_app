...
class UserCommunityChatsResponse {
    ...
    factory UserCommunityChatsResponse.fromJson(String str) => UserCommunityChatsResponse.fromMap(json.decode(str));

    String toJson() => json.encode(toMap());

    factory UserCommunityChatsResponse.fromMap(Map<String, dynamic> json) => UserCommunityChatsResponse(
