...
class UserAndCommunityMixContentResponse {
    ...
    factory UserAndCommunityMixContentResponse.fromJson(String str) => UserAndCommunityMixContentResponse.fromMap(json.decode(str));

    String toJson() => json.encode(toMap());

    factory UserAndCommunityMixContentResponse.fromMap(Map<String, dynamic> json) => UserAndCommunityMixContentResponse(
