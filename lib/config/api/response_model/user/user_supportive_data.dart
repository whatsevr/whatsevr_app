...
class UserSupportiveDataResponse {
    ...
    factory UserSupportiveDataResponse.fromJson(String str) => UserSupportiveDataResponse.fromMap(json.decode(str));

    String toJson() => json.encode(toMap());

    factory UserSupportiveDataResponse.fromMap(Map<String, dynamic> json) => UserSupportiveDataResponse(
        message: json["message"],
        userInfo: json["user_info"] == null ? null : UserInfo.fromMap(json["user_info"]),
        ownedCommunities: json["owned_communities"] == null ? [] : List<OwnedCommunity>.from(json["owned_communities"]!.map((x) => OwnedCommunity.fromMap(x))),
    );

    Map<String, dynamic> toMap() => {
        "message": message,
        "user_info": userInfo?.toMap(),
        "owned_communities": ownedCommunities == null ? [] : List<dynamic>.from(ownedCommunities!.map((x) => x.toMap())),
    };
}
...
class OwnedCommunity {
    ...
    factory OwnedCommunity.fromJson(String str) => OwnedCommunity.fromMap(json.decode(str));
