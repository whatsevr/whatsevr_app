...
class UserTrackedActivitiesResponse {
  ...
  factory UserTrackedActivitiesResponse.fromJson(String str) =>
      UserTrackedActivitiesResponse.fromMap(json.decode(str));

  String toJson() => json.encode(toMap());

  factory UserTrackedActivitiesResponse.fromMap(Map<String, dynamic> json) =>
      UserTrackedActivitiesResponse(
  ...
  Map<String, dynamic> toMap() => {
        ...
        'activities': activities == null
            ? []
            : List<dynamic>.from(activities!.map((x) => x.toMap())),
      };
}
...
class Activity {
  ...
  factory Activity.fromMap(Map<String, dynamic> json) => Activity(
        ...
        comment:
            json['comment'] == null ? null : Comment.fromMap(json['comment']),
        commentReply: json['comment_reply'] == null
            ? null
            : CommentReply.fromMap(json['comment_reply']),
      );
...
class CommentReply {
  ...
  factory CommentReply.fromJson(String str) =>
      CommentReply.fromMap(json.decode(str));
