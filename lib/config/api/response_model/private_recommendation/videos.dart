...
class PrivateRecommendationVideosResponse {
  final String? message;
  final int? page;
  final bool? lastPage;
  final List<RecommendedVideo>? recommendedVideos;

  PrivateRecommendationVideosResponse({
    this.message,
    this.page,
    this.lastPage,
  ...
  PrivateRecommendationVideosResponse copyWith({
    String? message,
    int? page,
    bool? lastPage,
  ...
  factory PrivateRecommendationVideosResponse.fromJson(String str) =>
      PrivateRecommendationVideosResponse.fromMap(json.decode(str));

  String toJson() => json.encode(toMap());

  factory PrivateRecommendationVideosResponse.fromMap(Map<String, dynamic> json) =>
      PrivateRecommendationVideosResponse(
