...
class PrivateRecommendationMixContentResponse {
    ...
    PrivateRecommendationMixContentResponse copyWith({
        String? message,
        List<Datum>? data,
        bool? hasMore,
        int? page,
    ...
    factory PrivateRecommendationMixContentResponse.fromJson(String str) => PrivateRecommendationMixContentResponse.fromMap(json.decode(str));

    String toJson() => json.encode(toMap());

    factory PrivateRecommendationMixContentResponse.fromMap(Map<String, dynamic> json) => PrivateRecommendationMixContentResponse(
