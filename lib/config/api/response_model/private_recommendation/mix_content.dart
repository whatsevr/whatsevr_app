...
class PrivateRecommendationMixContentResponse {
  ...
  factory PrivateRecommendationMixContentResponse.fromJson(String str) =>
      PrivateRecommendationMixContentResponse.fromMap(json.decode(str));

  String toJson() => json.encode(toMap());

  factory PrivateRecommendationMixContentResponse.fromMap(
