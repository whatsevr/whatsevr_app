...
class PrivateRecommendationMixCommunityContentResponse {
    ...
    factory PrivateRecommendationMixCommunityContentResponse.fromJson(String str) => PrivateRecommendationMixCommunityContentResponse.fromMap(json.decode(str));

    String toJson() => json.encode(toMap());

    factory PrivateRecommendationMixCommunityContentResponse.fromMap(Map<String, dynamic> json) => PrivateRecommendationMixCommunityContentResponse(
        message: json["message"],
        communityMixContent: json["community_mix_content"] == null ? [] : List<CommunityMixContent>.from(json["community_mix_content"]!.map((x) => CommunityMixContent.fromMap(x))),
    ...
    Map<String, dynamic> toMap() => {
        "message": message,
        "community_mix_content": communityMixContent == null ? [] : List<dynamic>.from(communityMixContent!.map((x) => x.toMap())),
...
class CommunityMixContent {
    ...
    factory CommunityMixContent.fromJson(String str) => CommunityMixContent.fromMap(json.decode(str));

    String toJson() => json.encode(toMap());

    factory CommunityMixContent.fromMap(Map<String, dynamic> json) => CommunityMixContent(
