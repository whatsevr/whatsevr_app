...
class PrivateRecommendationFlicksResponse {
  ...
  PrivateRecommendationFlicksResponse copyWith({
    String? message,
    int? page,
    bool? lastPage,
  ...
  factory PrivateRecommendationFlicksResponse.fromJson(String str) =>
      PrivateRecommendationFlicksResponse.fromMap(json.decode(str));

  String toJson() => json.encode(toMap());

  factory PrivateRecommendationFlicksResponse.fromMap(Map<String, dynamic> json) =>
      PrivateRecommendationFlicksResponse(
