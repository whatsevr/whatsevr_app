...
class TopCommunitiesResponse {
  ...
  TopCommunitiesResponse copyWith({
    String? message,
    int? page,
    bool? lastPage,
  ...
  factory TopCommunitiesResponse.fromJson(String str) =>
      TopCommunitiesResponse.fromMap(json.decode(str));

  String toJson() => json.encode(toMap());

  factory TopCommunitiesResponse.fromMap(Map<String, dynamic> json) =>
      TopCommunitiesResponse(
  ...
  Map<String, dynamic> toMap() => {
        ...
        'page': page,
        'last_page': lastPage,
        'top_communities': topCommunities == null
            ? []
            : List<dynamic>.from(topCommunities!.map((x) => x.toMap())),
      };
}
...
class TopCommunity {
  ...
  factory TopCommunity.fromJson(String str) =>
      TopCommunity.fromMap(json.decode(str));

  String toJson() => json.encode(toMap());

  factory TopCommunity.fromMap(Map<String, dynamic> json) => TopCommunity(
        id: json['id'],
