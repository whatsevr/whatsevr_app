...
class CommunityMembersResponse {
    ...
    factory CommunityMembersResponse.fromJson(String str) => CommunityMembersResponse.fromMap(json.decode(str));

    String toJson() => json.encode(toMap());

    factory CommunityMembersResponse.fromMap(Map<String, dynamic> json) => CommunityMembersResponse(
...
class Datum {
    ...
    factory Datum.fromMap(Map<String, dynamic> json) => Datum(
        ...
        invitedBy: json["invited_by"] == null ? null : Member.fromMap(json["invited_by"]),
    );
