...
class PublicRecommendationMemoriesResponse {
  final String? message;
  final int? page;
  final bool? lastPage;
  final List<RecommendedMemory>? recommendedMemories;

  PublicRecommendationMemoriesResponse({
    this.message,
    this.page,
    this.lastPage,
  ...
  PublicRecommendationMemoriesResponse copyWith({
    String? message,
    int? page,
    bool? lastPage,
  ...
  factory PublicRecommendationMemoriesResponse.fromJson(String str) =>
      PublicRecommendationMemoriesResponse.fromMap(json.decode(str));

  String toJson() => json.encode(toMap());

  factory PublicRecommendationMemoriesResponse.fromMap(Map<String, dynamic> json) =>
      PublicRecommendationMemoriesResponse(
