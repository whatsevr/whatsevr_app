...
class PublicRecommendationVideosResponse {
  final String? message;
  final int? page;
  final bool? lastPage;
  final List<RecommendedVideo>? recommendedVideos;

  PublicRecommendationVideosResponse({
    this.message,
    this.page,
    this.lastPage,
  ...
  PublicRecommendationVideosResponse copyWith({
    String? message,
    int? page,
    bool? lastPage,
  ...
  factory PublicRecommendationVideosResponse.fromJson(String str) =>
      PublicRecommendationVideosResponse.fromMap(json.decode(str));

  String toJson() => json.encode(toMap());

  factory PublicRecommendationVideosResponse.fromMap(Map<String, dynamic> json) =>
      PublicRecommendationVideosResponse(
