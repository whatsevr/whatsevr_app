...
class PublicRecommendationPhotoPostsResponse {
  ...
  PublicRecommendationPhotoPostsResponse copyWith({
    String? message,
    int? page,
    bool? lastPage,
  ...
  factory PublicRecommendationPhotoPostsResponse.fromJson(String str) =>
      PublicRecommendationPhotoPostsResponse.fromMap(json.decode(str));

  String toJson() => json.encode(toMap());

  factory PublicRecommendationPhotoPostsResponse.fromMap(Map<String, dynamic> json) =>
      PublicRecommendationPhotoPostsResponse(
