...
class PublicRecommendationOffersResponse {
  ...
  PublicRecommendationOffersResponse copyWith({
    String? message,
    int? page,
    bool? lastPage,
  ...
  factory PublicRecommendationOffersResponse.fromJson(String str) =>
      PublicRecommendationOffersResponse.fromMap(json.decode(str));
