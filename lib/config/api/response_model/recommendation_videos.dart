...
class RecommendationVideosResponse {
  ...
  factory RecommendationVideosResponse.fromJson(String str) => RecommendationVideosResponse.fromMap(json.decode(str));

  String toJson() => json.encode(toMap());

  factory RecommendationVideosResponse.fromMap(Map<String, dynamic> json) => RecommendationVideosResponse(
    message: json["message"],
    recommendedVideos: json["recommended_videos"] == null ? [] : List<RecommendedVideo>.from(json["recommended_videos"]!.map((x) => RecommendedVideo.fromMap(x))),
  );

  Map<String, dynamic> toMap() => {
    "message": message,
    "recommended_videos": recommendedVideos == null ? [] : List<dynamic>.from(recommendedVideos!.map((x) => x.toMap())),
  };
}
...
class RecommendedVideo {
  ...
  factory RecommendedVideo.fromJson(String str) => RecommendedVideo.fromMap(json.decode(str));

  String toJson() => json.encode(toMap());

  factory RecommendedVideo.fromMap(Map<String, dynamic> json) => RecommendedVideo(
    id: json["id"],
