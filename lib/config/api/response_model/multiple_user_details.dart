...
class MultipleUserDetailsResponse {
  ...
  MultipleUserDetailsResponse copyWith({
    String? message,
    List<User>? users,
  }) =>
      MultipleUserDetailsResponse(
  ...
  factory MultipleUserDetailsResponse.fromJson(String str) => MultipleUserDetailsResponse.fromMap(json.decode(str));

  String toJson() => json.encode(toMap());

  factory MultipleUserDetailsResponse.fromMap(Map<String, dynamic> json) => MultipleUserDetailsResponse(
