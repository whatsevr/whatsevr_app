...
class TrackActivitiesRequest {
  ...
  factory TrackActivitiesRequest.fromJson(String str) =>
      TrackActivitiesRequest.fromMap(json.decode(str));

  String toJson() => json.encode(toMap());

  factory TrackActivitiesRequest.fromMap(Map<String, dynamic> json) =>
      TrackActivitiesRequest(
